...
namespace ShatranjCore.UI
{
    ...
    public class ConsoleBoardRenderer
    {
        ...
        public void DisplayCommands()
        {
            ...
            Console.WriteLine("  castle [side]       - Castle (king/k, queen/q, or just 'castle' for prompt)");
            Console.WriteLine("  undo                - Undo previous turn (rollback)");
            Console.WriteLine("  redo                - Redo last undo");
            Console.WriteLine();
            ...
            Console.WriteLine("  load [gameId]       - Load a saved game (or list all if no ID)");
            Console.WriteLine("  restart             - Restart the current game");
            Console.WriteLine("  end                 - End current game");
            Console.WriteLine();
            Console.WriteLine("  SETTINGS:");
            Console.WriteLine("  settings            - Show/change game settings");
            Console.WriteLine("  settings difficulty [level] - Set AI difficulty (easy/medium/hard/veryhard/titan)");
            Console.WriteLine();
